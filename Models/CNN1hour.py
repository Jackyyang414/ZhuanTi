# -*- coding: utf-8 -*-
"""
Created on Fri May  3 20:05:31 2019
...
np.save("D:/ZhuanTi/RadarEchoDatabase/PreprocessedRadarValue.npy",RList)
...
model = Sequential()
#Conv1
model.add(Conv3D(filters=32, kernel_size=(3,3,1), padding='same', input_shape=(21,21,21,5), activation='relu'))

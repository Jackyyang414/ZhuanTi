...
from keras.layers import Conv3D,MaxPooling3D,LSTM,Permute, Reshape
...
model = Sequential()
#Conv1
model.add(Conv3D(filters=32, kernel_size=(3,3,1), padding='same', input_shape=(6,21,21,21), activation='relu'))
